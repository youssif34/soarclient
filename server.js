...
setInterval(() => {
    http.get(`http://youssif101games-news.glitch.me/`); /// حط اسم المشروع تبعك name تعديل مهم بدل
}, 280000);
...
client.on("message", async message => {
    ...
    if (message.content.startsWith(prefix + "bc")) {
        ...
        let args = message.content
            ...
            .slice(1)
            .join(" ");
        if (!message.author.id === "1135306459127758928") return; /// تعديل مهم حط الايدي تبعك
...
client.on("ready", () => {
    client.user.setActivity(`Youssif101_games ${prefix}bc`, { ///تعديل مهم حالة البوت
        type: "WATCHING"
    }); ///تعديل حالة البوت
});
